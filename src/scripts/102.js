...
function updateCurrentTime() {
    ...
    document.getElementById('destination').innerHTML = `<h2 class="text-4xl text-primary-content dark:text-primary font-bold">Direction BRINTE Avenue de la Liberté</h2><br>`;
