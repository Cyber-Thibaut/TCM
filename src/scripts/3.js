...
function calculateNextBusTime(weekday, hour, minute, isVacation, isHoliday) {
    ...
    const frequencies = {
        weekday: {
            '4-7': 9, '7-9': 6, '9-16': 9, '16-20': 6, '20-24': 16
        },
        saturday: {
            '4-7': 13, '7-9': 9, '9-16': 13, '16-20': 9, '20-24': 19
        },
        sunday: {
            '4-7': 16, '7-9': 13, '9-24': 16
        }
    };
...
function updateCurrentTime() {
    ...
    destinationElement.innerHTML = `<h2 class="text-4xl text-primary-content dark:text-primary font-bold">Direction Campus Gabriel Montpied (Santé) ♿</h2><br>`;
}
