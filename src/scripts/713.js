...
function updateBusTimes() {
    ...
    `;
        ...
        <div role="alert" class="alert alert-warning">
            ...
            <span>Rendez-vous le 2 août pour les premières épreuves à la Maison des Sports !</span>
        </div>
    `;
    }
}
...
function updateCurrentTime() {
    ...
    document.getElementById('destination').innerHTML = `<h2 class="text-4xl text-primary-content dark:text-primary font-bold">Direction Maison des Sports ♿</h2><br>`;
